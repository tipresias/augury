...
LAST_SEASON_PLAYED = 2020
CV_YEAR_RANGE = (LAST_SEASON_PLAYED - 5, LAST_SEASON_PLAYED)
TRAIN_YEAR_RANGE = (LAST_SEASON_PLAYED - 2,)
VALIDATION_YEAR_RANGE = (LAST_SEASON_PLAYED - 2, LAST_SEASON_PLAYED)
TEST_YEAR_RANGE = (LAST_SEASON_PLAYED, LAST_SEASON_PLAYED + 1)
FULL_YEAR_RANGE = (LAST_SEASON_PLAYED + 1,)
